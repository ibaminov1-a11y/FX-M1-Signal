...
public final class FeatureEngine {
    ...
    public static JSONObject managePayload(SharedPreferences p) throws Exception {
        ...
        // V10.1 NORMAL HOLD: broker-side SL remains the emergency protection,
        // but BE/trailing/partial must not cut a valid swing campaign before the
        // confirmed peak/bottom or structure-break exit generated by MonitoringService.
        o.put("break_even_enabled", false);
        o.put("break_even_at_r", p.getFloat("break_even_at_r", 1.0f));
        o.put("trailing_enabled", false);
    ...
    public static String featureSummary(SharedPreferences p) {
        ...
        return "Режим: " + p.getString("execution_mode", "FULL_AUTO") +
                ...
                "\nBE: OFF · Trailing: OFF · EXIT: SWING/PEAK" +
                "\nPartial: OFF" +
